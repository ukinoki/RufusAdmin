...
B. La structure de la table Impressions
    ...
    * Titre
        ...
        * Titre de la prescription ou du courrier tel qu’il est inscrit dans la fiche dlg_impressions si ce document est émis par la diche dlg_impressions
...
C. Les documents émis par le poste utilisateur
    ...
    Les 2 fiches élaborent
        * un string html qui correspond au corps du document
    ...
    Les 3 QString sont ensuite stockés dans la table impressions avec les autres renseignements: idpatient, iduser, idlieu, prescription ou pas...etc...
D. Les documents d’imagerie
    Le fonctionnement est plus complexe.
    a - les documents d’imagerie émis sur le réseau local
        Les documents d’imagerie sont émis par les appareils d’imagerie sur un dossier de sockage provisoire du réseau local qui leur est propre.
            ·   Ce dossier est en général un sous-dossier du dossier /DossierEchange,
            ·   lui-même sous dossier du dossier de stockage sur le serveur référencé dans le champ DirImagerie de la table ParametresSysteme,
            ·   lui-même sous dossier du dossier /Documents/Rufus sur le serveur.
        ...
        La fonction setPostImports de procedures.h s’occupe de rédiger la procédure SQL PosteImports  qui détermine le poste importateur.
        Un système de timer vérifie sur chaque poste que le poste importateur ne s’est pas déconnecté auquel cas un autre poste prend sa place.
        ...
        Quand un document est trouvé dans un de ces dossier, il est intégré dans la base comme les prescriptions mais le fichier est recopié dans un sous dossier du dossier référencé par DirImagerie.
            ·   Pour les images, ce sous dossier porte le nom de la date du jour et est un sous-dossier du dossier /Images, p.e /Images/2016-05-28
            ·   Pour les videos, ce sous dossier est le dossier /Videos

        Ce dossier est lui-même un sous dossier du dossier de stockage de l’imagerie sur le serveur
        lui-même sous dossier du dossier /Documents/Rufus sur le serveur
        le tout référencé dans le champ DirImagerie de la table ParametresSysteme, soit en général un truc du genre
            ·   /Users/rodolphe/Documents/Rufus/Imagerie

        Le fichier est renommé avec la convention
            ·   idPatient_TypeDoc_SousTypeDoc_Date et heure création du doc_IdImpression.(jpg ou pdf) pour les impressions
            ·   idPatient_SousTypeDoc_Date et heure création du doc_IdImpression.(extension) pour les videos
        le tout est stocké dans la table Impressions, dans le champ LienVersFichier, sous la forme du chemin relatif depuis le dossier DirImagerie du serveur soit
            ·   /Images/DateduJour/nomdufichier pour les images
            ·   /Videos/ nomdufichier pour les videos
        Si le poste responsable de l’import n’est pas le serveur mais est sur le réseau local,
            ·   il utilise l’adresse relative stockée dans son rufus.ini pour retrouver le chemin de DirImagerie sur le serveur
        ...
        Le chemin final du fichier est donc la concaténation du champ DirImagerie de la table ParametresSysteme et du champ LienVersFichier de la table Impressions
            ·   DirImagerie         = /Users/rodolphe/Documents/Rufus/Imagerie
            ·   LienVersFichier     = /Images/2018-09-18/6313_RNM_Eidon OD_20180918-183257-51680.jpg
            ·   Chemin du fichier   = /Users/rodolphe/Documents/Rufus/Imagerie/Images/2018-09-18/6313_RNM_Eidon OD_20180918-183257-51680.jpg
        ...
        Pour la lecture des documents sur un poste Rufus, c’est la classe dlg_docsexternes.h qui s’en occupe.
            ...
            ·   en stockant le fichier avec son idImpression dans le champ blocb pdf ou jpg decette table
...
E. La suppression des documents
    Se fait à partir de l’icône poubelle de la fiche dlg_docexternes ou du menu contextuel de la fiche.
...
I - ENREGISTREMENT D'UN FICHIER
    ...
    A. L'enregistrement d'un fichier pdf ou jpg
        a - Sur le réseau local du serveur
            ...
            les jpg sont comprimés jusqu'à une taille maximale (256Ko) définie dans macros.h avant d'être incorporés dans la base
                ·   le fichier est renommé et copié dans le sous-dossier /Images/DateduJour du dossier d'imagerie tel qu'il est défini dans la table ParametresSysteme champ Dirimagerie
            ...
            Sur tous les postes, un timer vérifie chaque minute que le poste responsable de l'import, désigné par la variable SQL PosteImportsDocs, est toujours connecté.
            En cas de déconnexion de ce poste, un autre poste prend la place en fonction de l'ordre de priorité RufusAdmin->RufusPrioritaire->Rufusnonprioritaire
            Pour une instance rufus, on choisit si elle est prioritaire dans la fiche dlg_param, onglet Ce Poste - le choix dépend du poste et pas de l'utilisateur et est enregistré dans rufus.ini du poste
        ...
        b - à distance
            ...
            les jpg sont comprimés jusqu'à une taille maximale (256Ko) définie dans macros.h avant d'être incorporés dans la base
            un poste va importer dans la base le fichier d'imagerie en créant l'enregistrement dans la table Impressions et en enregistrant le contenu du fichier dans le champ jpg ou pdf de cet enregistrement.
            ...
            le poste importateur sur le réseau local du serveur va extraire ce fichier et le recréer dans le sous-dossier Images du dossier d'imagerie tel qu'il est défini dans la table ParametreSysteme champ Dirimagerie
    ...
    C. L'enregistrement d'un document scanné
        a - Sur le réseau local du serveur
    ...
    D. L'enregistrement d'une facture
